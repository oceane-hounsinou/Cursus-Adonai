...
<title>Connexion Admin | ISM ADONAÏ</title>
...
<section class="section-connexion">
    <div class="carte-connexion">
        ...
        <form action="traitement_admin.php" method="POST" autocomplete="off">
            <div class="mb-3">
            ...
            <button type="submit" class="btn-connexion">Se connecter à l'espace Admin</button>
        </form>
    </div>
</section>
